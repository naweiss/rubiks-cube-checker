...
def test_do_move_double_notation(scrambled_cube_state: Dict[str, np.ndarray], move: str) -> None:
    cube_a = RubiksCube(faces=scrambled_cube_state)
    cube_b = RubiksCube(faces=scrambled_cube_state)
...
def test_do_move_inverse_notation(scrambled_cube_state: Dict[str, np.ndarray], move: str) -> None:
    cube_a = RubiksCube(faces=scrambled_cube_state)
    cube_b = RubiksCube(faces=scrambled_cube_state)
...
def test_do_move_multiple(cube_scramble_moves: List[str], scrambled_cube_state: Dict[str, np.ndarray]) -> None:
    cube = RubiksCube()
